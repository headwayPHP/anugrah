                            ...
                            <form action="{{ route('batches.update', $batch->id) }}" method="POST">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="day_of_week[]" class="form-select" multiple>
                                            @foreach($daysOfWeek as $day)
                                                <option
                                                    value="{{ $day }}" {{ in_array($day, $batch->days_array) ? 'selected' : '' }}>
                                                    {{ $day }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="time" class="form-control" value="{{ $batch->time }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="mode" class="form-select">
                                            ...
                                            @foreach($modes as $mode)
                                                <option
                                                    value="{{ $mode }}" {{ $batch->mode == $mode ? 'selected' : '' }}>{{ $mode }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="mb-3">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="day_of_week[]" class="form-select" multiple>
                                @foreach($daysOfWeek as $day)
                                    <option
                                        value="{{ $day }}" {{ in_array($day, old('day_of_week', [])) ? 'selected' : '' }}>
                                        {{ $day }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="mode" class="form-select">
                                ...
                                @foreach($modes as $mode)
                                    <option
                                        value="{{ $mode }}" {{ old('mode') == $mode ? 'selected' : '' }}>{{ $mode }}</option>
                                @endforeach
                            </select>
                            @error('mode')
                            <div class="text-danger mt-1">{{ $message }}</div>
