                ...
                @foreach ($posts as $i => $post)
                    <tr class="hover-actions-trigger {{ $loop->odd ? 'bg-light' : '' }}">
                        ...
                        <td class="align-middle">
                            <a href="{{ $post->url }}" target="_blank" class="text-truncate"
                        ...
                        <td class="align-middle">
                            @if ($post->banner)
                                <img src="{{ asset($post->banner) }}" alt="{{ $post->title }}" width="80"
                        ...
                        <td class="align-middle text-center">
                            <div class="d-flex justify-content-center gap-1">
                                ...
                                <button class="btn btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#editPostModal{{ $post->id }}" title="Edit">
                                        ...
                                        <form action="{{ route('social-posts.update', $post->id) }}" method="POST"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="date" name="date" class="form-control"
                                                    value="{{ \Carbon\Carbon::parse($post->date)->format('Y-m-d') }}"
                                                    required>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                @if ($post->banner)
                                                    <div class="mt-2">
                                                        ...
                                                        <img src="{{ asset($post->banner) }}" alt="Current banner"
