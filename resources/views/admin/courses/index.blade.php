...
@section('sub-section')
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <button class="btn btn-primary btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#create-course-modal">
            + Add New Course
        </button>
    </div>
        ...
        <table class="table table-hover align-middle">
            ...
            <tbody>
                @foreach ($courses as $i => $course)
                    ...
                    <div class="modal fade" id="show-course-modal-{{ $course->id }}" tabindex="-1" role="dialog"
                        aria-hidden="true">
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <p>{{ $course->duration_weeks ? $course->duration_weeks . ' weeks' : 'N/A' }}
                                                </p>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <p>
                                                    <span
                                                        class="badge {{ $course->status == 1 ? 'bg-success' : 'bg-danger' }}">
                                        ...
                                        <form action="{{ route('courses.update', $course->id) }}" method="POST"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="file" accept="image/*" name="image"
                                                    class="form-control" value="{{ $course->image }}">
                                            </div>
                                            <div class="mb-3">
