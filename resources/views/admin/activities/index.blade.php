        ...
        <table class="table table-hover align-middle">
            ...
            <tbody>
                @foreach ($activities as $i => $activity)
                    <tr class="hover-actions-trigger {{ $loop->odd ? 'bg-light' : '' }}">
                        ...
                        <td class="align-middle">
                            @if ($activity->featured_image)
                                <img src="{{ asset($activity->featured_image) }}" alt="Activity Image" width="80"
                                    height="60" style="object-fit: cover; border-radius: 0.25rem;">
                            @endif
                        </td>
                        <td class="align-middle">
                        ...
                        <td class="align-middle text-center">
                            <div class="d-flex justify-content-center gap-1">
                                ...
                                <button class="btn btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#showModal{{ $activity->id }}" data-bs-toggle="tooltip" title="View">
                                    <i class="fas fa-eye"></i>
                                </button>

                                <!-- Edit Button -->
                                <button class="btn btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#editModal{{ $activity->id }}" data-bs-toggle="tooltip" title="Edit">
                    ...
                    <!-- Show Modal -->
                    <div class="modal fade" id="showModal{{ $activity->id }}" tabindex="-1" role="dialog"
                        aria-hidden="true">
                            ...
                            <div class="modal-content position-relative">
                                ...
                                <div class="modal-body p-0">
                                    ...
                                    <div class="p-4 pb-0">
                                        ...
                                        @if ($activity->featured_image)
                                            <p><strong>Image:</strong><br><img src="{{ asset($activity->featured_image) }}"
                                                    width="100%" style="max-width: 300px;" alt="Activity Image"></p>
                                        @endif
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <form action="{{ route('activities.update', $activity->id) }}" method="POST"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="is_featured" class="form-select">
                                                    <option value="1" {{ $activity->is_featured ? 'selected' : '' }}>
                                                        Yes</option>
                                                    <option value="0"
                                                        {{ !$activity->is_featured ? 'selected' : '' }}>No</option>
                                                </select>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Status</label>
                                                <select name="status" class="form-select">
                                                    <option value="1" {{ $activity->status ? 'selected' : '' }}>
                                                        Active</option>
                                                    <option value="0" {{ !$activity->status ? 'selected' : '' }}>
                                                        Inactive</option>
                                                </select>
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                @if ($activity->featured_image)
                                                    <div class="mt-2">
                                                        <img src="{{ asset($activity->featured_image) }}" width="100"
