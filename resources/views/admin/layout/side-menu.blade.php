        ...
        <div class="navbar-vertical-content scrollbar">
            <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                <li class="nav-item">
                    ...
                    <!-- parent pages--><a class="nav-link {{ request()->routeIs('admin.home') ? 'active' : '' }}" href="{{route('admin.home')}}" role="button">
...
{{--                    </a>--}}
                    <!-- parent pages--><a class="nav-link {{ request()->routeIs('courses.index') ? 'active' : '' }}" href="{{route('courses.index')}}" role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                    class="fas fa-book"></span></span><span
                                class="nav-link-text ps-1">Courses</span></div>
                    </a>
                    <!-- parent pages--><a class="nav-link {{ request()->routeIs('batches.index') ? 'active' : '' }}" href="{{route('batches.index')}}" role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                    class="fas fa-layer-group"></span></span><span
                                class="nav-link-text ps-1">Batches</span></div>
                    </a>
                    <!-- parent pages--><a class="nav-link {{ request()->routeIs('students.index') ? 'active' : '' }}" href="{{route('students.index')}}" role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                    class="fas fa-user-graduate"></span></span><span
                                class="nav-link-text ps-1">Students</span></div>
                    </a>
                    <!-- parent pages--><a class="nav-link {{ request()->routeIs('attendances.index') ? 'active' : '' }}" href="{{route('attendances.index')}}" role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                    class="fas fa-clipboard-check"></span></span><span
                                class="nav-link-text ps-1">Attendance management</span></div>
                    </a>
                    <!-- parent pages--><a class="nav-link {{ request()->routeIs('activities.index') ? 'active' : '' }}" href="{{route('activities.index')}}" role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                    class="fas fa-running"></span></span><span
                                class="nav-link-text ps-1">Activities</span></div>
                    </a>
                    <!-- parent pages--><a class="nav-link {{ request()->routeIs('contact-requests.index') ? 'active' : '' }}" href="{{route('contact-requests.index')}}" role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                    class="fas fa-envelope"></span></span><span
                                class="nav-link-text ps-1">Contact Requests</span></div>
                    </a>
                    <!-- parent pages--><a class="nav-link {{ request()->routeIs('req_requests.index') ? 'active' : '' }}" href="{{route('req_requests.index')}}" role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                    class="fas fa-user-plus"></span></span><span
                                class="nav-link-text ps-1">Registration Requests</span></div>
                    </a>
                    <!-- parent pages--><a class="nav-link {{ request()->routeIs('photos.index') ? 'active' : '' }}" href="{{route('photos.index')}}" role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                    class="fas fa-images"></span></span><span
                                class="nav-link-text ps-1">Gallery</span></div>
                    </a>
                    <!-- parent pages--><a class="nav-link {{ request()->routeIs('social-posts.index') ? 'active' : '' }}" href="{{route('social-posts.index')}}" role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                    class="fas fa-share-alt"></span></span><span
                                class="nav-link-text ps-1">Social Media</span></div>
                    </a>
                    <!-- parent pages--><a class="nav-link {{ request()->routeIs('pages.index') ? 'active' : '' }}" href="{{route('pages.index')}}" role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                    class="fas fa-file-alt"></span></span><span
                                class="nav-link-text ps-1">Pages</span></div>
                    </a>
                    <!-- parent pages--><a class="nav-link {{ request()->routeIs('settings.edit') ? 'active' : '' }}" href="{{route('settings.edit')}}" role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
