...
<footer class="footer-area bg-footer">
    <div class="footer-top section-space--ptb_50 section-pb">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="copy-right-box">
                        <p class="">Copyright &copy; 2025 Headway Business solutions LLP <a
                                href="https://headway.org.in/" target="_blank">All Right Reserved</a>.</p>
                        <p class=" "><a href="{{ route('privacyPage') }}">Privacy policy</a></p>
                    </div>
                </div>
            </div>
        </div>
