...
<div class="icon-bar">
    <a href="{{$instagram->value}}" class="instagram"><i class="fa fa-instagram"></i></a>
    <!--    <a href="#" class="twitter"><i class="fa fa-twitter"></i></a>-->
    <!--    <a href="#" class="google"><i class="fa fa-google"></i></a>-->
    <a href="{{$facebook->value}}" class="facebook"><i class="fa fa-facebook"></i></a>
    <a href="{{$youtube->value}}" class="youtube"><i class="fa fa-youtube"></i></a>
</div>
