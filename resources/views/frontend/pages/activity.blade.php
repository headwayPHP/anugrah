                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="single-service-wrap mt-40">
                                <div class="service-image">
                                    <a href="{{ route('front.activity.details', $activity->id) }}"><img src="{{asset($activity->featured_image)}}" class="img-fluid" alt="Service image"></a>
                                </div>
                                <div class="service-content">
                                    <h4 class="service-title"><a href="{{ route('front.activity.details', $activity->id) }}">{{$activity->title}}</a></h4>
