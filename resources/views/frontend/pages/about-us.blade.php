...
@section('content')
    ...
    <div class="site-wrapper-reveal" style="text-align: justify !important;">
                ...
                <div class="row align-items-start">
                    ...
                    <div class="col-lg-6 mb-4 mb-lg-0 ">
                        <div class="about-tai-image text-center text-lg-start">
                            @if ($about->image)
                                <img src="{{ asset($about->image) }}" class="img-fluid rounded" width="600"
                                    height="400" alt="About Image" style="max-height: 520px; object-fit: cover;">
                            @else
                        ...
                        <div class="about-tai-content ps-lg-5">
                            ...
                            @if ($about->content)
                                ...
                                <div class="content-text html-content">
                                    @if ($about->content)
                                        @php
                                            // Remove &nbsp; and empty paragraphs/headings
                                            $cleanContent = preg_replace(
                                                ['/&nbsp;/i', '/<p>\s*<\/p>/i', '/<h[1-6]>\s*<\/h[1-6]>/i'],
                                                '',
                                                $about->content,
                                            );

                                            // Split content at first closing </p> tag
                                            $contentParts = preg_split(
                                                '~(</p>)~i', // Using ~ as delimiter to avoid escaping slashes
                                                $cleanContent,
                                                2,
                                                PREG_SPLIT_DELIM_CAPTURE,
                                            );

                                            $firstPart = isset($contentParts[0], $contentParts[1])
                                                ? $contentParts[0] . $contentParts[1]
                                                : '';
                                        @endphp
                                        {!! $firstPart !!}
                                    @endif
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section-title-wrap text-center section-space--mb_40">
                            <h3 class="section-title--two  center-style mb-30">Anugrah Pathshala Youtube Video</h3>
                        </div>
                    </div>
                </div>
                <div class="about-video-box justify-content-center about-video-bg">
                    <div class="col-lg-6 ml-auto mr-auto">
                        <div class="video-content-wrap text-center">
                            <div class="icon">
                                <a href="{{ $yt_link->value }}" class="video-link popup-youtube">
