...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 position-relative">
                    <h3 class="breadcrumb-title text-black">{{ \Illuminate\Support\Str::ucfirst($course->title) }}
                    </h3>
                    <!-- breadcrumb-list start -->
                    <ul class="breadcrumb-list">
                        <li class="breadcrumb-item"><a href="{{ route('front.home') }}">Home</a></li>
                        <li class="breadcrumb-item active">{{ \Illuminate\Support\Str::ucfirst($course->title) }}
                        </li>
                    </ul>
                    <!-- breadcrumb-list end -->
                </div>
    ...
    <div class="site-wrapper-reveal">
                            ...
                            <div class="col-lg-6">
                                <div class="donation-content ml-lg-5">
                                    <div class="donation-title mb-30">
                                        <h4 class="mb-15">{{ \Illuminate\Support\Str::ucfirst($course->title) }}
                                        </h4>
                                    ...
                                    <div class="target-content">
                                        <ul class="mt-30 mision-list">
                                            <li><b>Duration</b>: {{ $course->duration_weeks }} weeks <br /> <b>Language</b>:
                                                {{ $course->language }} <br /> <b>Level</b>: {{ $course->level }}</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-4 col-md-6 col-sm-6">
                                                                        <div class="mission-wrap mr-lg-5">
                                                                            <div class="section-title-wrap text-left">
                                                                                <h4 class="section-title-normal mb-30">Course Details</h4>
                                                                            </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="target-wrap ml-lg-5 small-mt__40 ">
                            <div class="section-title-wrap text-left">
                                <h4 class="section-title-normal mb-30">Spiritual Center </h4>
                            </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="target-wrap ml-lg-5 tablet-mt__40 small-mt__40 ">
                            <div class="section-title-wrap text-left">
                                <h4 class="section-title-normal mb-30">Location Details </h4>
                            </div>

                            <div class="target-content">
                                <div id="googleMap-1" class="embed-responsive-item googleMap-2" data-lat="40.730610"
                                    data-Long="-73.935242">
                                    <iframe src="{{ $googl_map_url->value }}" style="border:0;width:100%;height:100%;"
        ...
        @if ($batches->count() > 0)
            @include('frontend.components.course-batches')
        @else
